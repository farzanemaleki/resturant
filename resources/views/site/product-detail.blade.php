...
@section('main')
    <!--Slider Start-->
<section id="slider-sec" class="slider-sec parallax" style="background: url({{ asset('/food-shop/img/product-deatil-banner.jpg') }});">
            ...
            <div class="col-12">
                ...
                <div class="product-body">
                    ...
                    <div class="pro-detail-sec row">
                        <div class="col-12">
                            <h4 class="pro-heading text-center text-lg-left">Blue Berries</h4>
                    ...
                    <div class="row product-list product-detail">
                            ...
                            <div class="wrapper">
                                <div class="Gallery swiper-container img-magnifier-container" id="gallery">
                                    <div class="swiper-wrapper myimgs">
                                        <div class="swiper-slide"> <a href={{ asset("/food-shop/img/item1.jpg") }} data-fancybox="1" title="Zoom In"><img class="myimage" src={{ asset("/food-shop/img/item1.jpg") }} alt="gallery"/></a></div>
                                        <div class="swiper-slide"> <a href={{ asset("/food-shop/img/item1.jpg") }} data-fancybox="2" title="Zoom In"><img class="myimage" src={{ asset("/food-shop/img/item2.jpg") }} alt="thumnails"/></a></div>
                                        <div class="swiper-slide"> <a href={{ asset("/food-shop/img/item1.jpg") }} data-fancybox="3" title="Zoom In"><img class="myimage" src={{ asset("/food-shop/img/item3.jpg") }} alt="thumnails"/></a></div>
                                    </div>
                                </div>
                                <div class="Thumbs swiper-container" id="thumbs">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"> <img src={{ asset("/food-shop/img/item1.jpg") }} alt="thumnails"/></div>
                                        <div class="swiper-slide"> <img src={{ asset("/food-shop/img/item2.jpg") }} alt="thumnails"/></div>
                                        <div class="swiper-slide"> <img src={{ asset("/food-shop/img/item3.jpg") }} alt="thumnails"/></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 text-center text-lg-left">
                            <div class="product-single-price">
                                ...
                                <p class="pro-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. tellus lacus faucibus lectus.</p>
                            </div>
                            ...
                            <div class="product-tags-list">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><span class="d-inline">Categories: <a href="#">Food</a><span class="comma-separtor">,</span><a href="#">Fruits</a></span></li>
                                        <li class="breadcrumb-item" aria-current="page"><p class="d-inline">Tags: <a href="#">Fruits</a><span class="comma-separtor">,</span><a href="#">Food</a></li>
                                    </ol>
                                </nav>
                            </div>
                                                ...
                                                <div class="col-12 col-lg-2 p-0">
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-12 d-flex  justify-content-center">
                                                            <img src={{ asset("/food-shop/img/p1.jpg") }} alt="Generic placeholder image">
                                                        </div>
                                        ...
                                        <div class="media">
                                            <div class="row no-gutter">
                                                <div class="col-12 col-lg-2 p-0">
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-12 d-flex  justify-content-center">
                                                            <img src={{ asset("/food-shop/img/p2.jpg") }} alt="Generic placeholder image">
                                                        </div>
                                                        <div class="col-12 d-flex mt-2 justify-content-center">
                                                            <ul class="user-rating">
                                                                <li><a href="#"><i class="lni-star-filled"></i></a></li>
        ...
        <div class="container">
            ...
            <div class="best-products-carousel owl-carousel owl-themesss">
                <div class="item text-center">
                    <div class="product">
                        <div class="product-img">
                            <img src={{ asset("/food-shop/img/item1.jpg") }} alt="Team">
                ...
                <div class="item text-center">
                    <div class="product">
                        <div class="product-img">
                            <img src={{ asset("/food-shop/img/item2.jpg") }} alt="">
                            <div class="overlay-img">
                                <div class="overlay-content">
                                    <a href="#"><i class="las la-heart"></i></a>
                                    <a href="#"><i class="las la-shopping-bag"></i></a>
                ...
                <div class="item text-center">
                    <div class="product">
                        <div class="product-img">
                            <img src={{ asset("/food-shop/img/item3.jpg") }} alt="">
                            <div class="overlay-img">
                                <div class="overlay-content">
                                    <a href="#"><i class="las la-heart"></i></a>
                                    <a href="#"><i class="las la-shopping-bag"></i></a>
                ...
                <div class="item text-center">
                    <div class="product">
                        <div class="product-img">
                           <img src={{ asset("/food-shop/img/item4.jpg") }} alt="">
                            <div class="overlay-img">
                                <div class="overlay-content">
                                    <a href="#"><i class="las la-heart"></i></a>
                                    <a href="#"><i class="las la-shopping-bag"></i></a>
