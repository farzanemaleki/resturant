...
@section('main')
    <!--slider sec strat-->
<section id="slider-sec" class="slider-sec parallax" style="background: url({{ asset('/food-shop/img/blogs/s-blog-slider.jpg') }});">
                    ...
                    <div class="main_content text-center text-lg-left">
                        <div class="single_blog">
                            <div class="single_img">
                                <img src={{ asset("/food-shop/img/blogs/b2.jpg") }} alt="image"/>
                            </div>
                        ...
                        <div class="single_blog">
                            <div class="single_img">
                                <img src={{ asset("/food-shop/img/blogs/b1.jpg") }} alt="image"/>
                            </div>
                            <div class="single_detail">
                                <p class="blog-sub-heading text-center"><span></span>Most flexible one page</p>
                                <h2>Post With A Preview Images</h2>
                        ...
                        <div class="single_blog">
                            <div class="single_img">
                                <img src={{ asset("/food-shop/img/blogs/b3.jpg") }} alt="image"/>
                            </div>
                            <div class="single_detail">
                                <p class="blog-sub-heading text-center"><span></span>Most flexible one page</p>
                                <h2>Post With A Preview Images</h2>
                            ...
                            <div class="popular_posts">
                                ...
                                <div class="media-box row">
                                    <div class="col-5 box-img">
                                        <img src={{ asset("/food-shop/img/blogs/p1.jpg") }} alt="image">
                                    </div>
                                ...
                                <div class="media-box row">
                                    <div class="col-5 box-img">
                                        <img src={{ asset("/food-shop/img/blogs/p2.jpg") }} alt="image">
                                    </div>
                                    <div class="col-7 box-detail">
                                ...
                                <div class="media-box row">
                                    <div class="col-5 box-img">
                                        <img src={{ asset("/food-shop/img/blogs/p3.jpg") }} alt="image">
                                    </div>
                                    <div class="col-7 box-detail">
